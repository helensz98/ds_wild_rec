...
from implicit.bpr import BayesianPersonalizedRanking # better generalization
...
if __name__ == "__main__":
    ...
    bpm = BayesianPersonalizedRanking(args.factors, args.lr, args.regularization, iterations=args.iterations,
    ...
    if args.pred:
        ...
        for step in tqdm(range(num_steps)):
            _val_pred, _val_pred_scores = bpm.recommend(val_users[step*batch_size: (step+1)*batch_size], None,
